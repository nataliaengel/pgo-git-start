public class PickupPointShipment extends ShipmentOrder {
   ...
   public PickupPointShipment(String orderNumber, String customerName,
                               int distanceKm, double baseFee,
                               boolean insured, String lockerSize,
                               boolean fragile) {
   ...
   protected double calculateAdditionalFee() {
       double fee = 0;
       if (lockerSize.equals("S")) fee = 5;
       else if (lockerSize.equals("M")) fee = 10;
       else if (lockerSize.equals("L")) fee = 18;
       if (fragile) fee += 15;
       return fee;
   }
   @Override
